...
class Metric(SimpleClass):
    ...
    def mean_results(self):
        ...
        return [self.tp.sum(), self.fp.sum(), self.mp, self.mr, self.map50, self.map]
    ...
    def fitness(self):
        ...
        w = [0, 0, 0.0, 0.0, 0.1, 0.9]  # weights for [tp,fp, P, R, mAP@0.5, mAP@0.5:0.95]
    ...
    def update(self, results):
        ...
        """
        self.tp, self.fp, self.p, self.r, self.f1, self.all_ap, self.ap_class_index = results
...
class DetMetrics(SimpleClass):
    ...
    def keys(self):
        ...
        return ['metrics/tp(B)','metrics/fp(B)','metrics/precision(B)', 'metrics/recall(B)', 'metrics/mAP50(B)', 'metrics/mAP50-95(B)']
